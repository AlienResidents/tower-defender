...
*Researched 2026-07-19 AEST via web-researcher subagent (GLM-5.2). All browser/engine versions current as of mid-2026. Sources cited inline; unverified items listed at the end.*
...
| **License** | **AGPL v3**. README: *"Strudel code can only be shared within free/open source projects under the same license."* No commercial/dual-license offered. |
