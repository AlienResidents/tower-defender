...
| **M1**  | **Beauty spike**    | One static map: neon signage/holo ads, rain, volumetric smoke, searchlight cones, ambient audio bed; enemies gliding a path (no gameplay)               | **LOOK LOCKED** ✅ 2026-07-19 (tag `m1`)                                  |
